...
export async function onRequestGet({ request, env }) {
  ...
  const venues = await env.DB
    .prepare('SELECT email, venue_name, data, website, dropbox_url, brand, updated_at FROM venues ORDER BY updated_at DESC')
    .all();
  ...
  return Response.json({
    ...
    venues: venues.results.map(v => {
      ...
      return {
        ...
        website: v.website || null, dropbox_url: v.dropbox_url || null, brand, data,
      };
    }),
